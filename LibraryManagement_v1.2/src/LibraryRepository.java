...
public class LibraryRepository {
    // DB 연결 정보
    private final String URL = "jdbc:mariadb://192.168.204.20:3306/library";
     ...
     *@see <a href="https://github.com/park-woohyun/LibraryManagement/issues/1">Issue #1</a>
     *
    ...
    public User loadUser(String id, String pw) {
        ...
        String sql = "SELECT * FROM users WHERE user_id = '" + id + "' AND password = '" + pw + "'";  /**취약점*/
